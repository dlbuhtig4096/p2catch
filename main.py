...
def start():
    ...
    async def on_ready():
        ...
        while True:
            if not pause:
                ...
                await send_message(Config["spam"], base64.b64encode(os.urandom(15)).decode())
    ...
    async def on_message(message):
        try:
            ...
            if message.channel.id == int(Config["spawn"]):
            ...
            if message.author.id == int(poketwo) and message.channel.id == int(Config["spawn"]):
